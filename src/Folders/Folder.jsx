      ...
      <div className="main read-group-margin">
        ...
        <div className="Slide">
          <div className="slide-menu">
            <div
              className="sortBtn cursor"
              onClick={this.dubleSortMin}
            >
              {'<<'}
            </div>
          ...
          <div className="sortBtnList">
            ...
            >
              <option value={15} className="sortBtnList">
                15
              </option>
              <option value={25} className="sortBtnList">
                25
              </option>
              <option value={50} className="sortBtnList">
                50
              </option>
              <option value={100} className="sortBtnList">
                100
              </option>
            </select>
          </div>

          <div className="sortBtn colorRed">
            All count: {this.state.list}
          </div>
        </div>
